/*
Problem:
Given an array of integers (may contain positive, negative, and zero values)
and an integer K, find the length of the longest contiguous subarray
